...
#
#naoi:
#    Download URL: ftp://ftp.cpc.ncep.noaa.gov/NCSP/Dashboard/NAO.for.3m
#
#    Processing:
...
#        line   1: 1950-02, 0.320
#        line   2: 1950-03, 0.257
#        line   3: 1950-04,-0.073
#        ...
#
...
my $DATA_URL = 'ftp://ftp.cpc.ncep.noaa.gov/NCSP/Dashboard/NAO.for.3m';

# File name to store formatted data
my $LOCAL_FILE_NAME = 'climate_vari_NAO.csv';
